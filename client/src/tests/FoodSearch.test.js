...
//tell jest to mock Client seach function, but not invoke it
jest.mock('../Client');
...
describe('FoodSearch', () => {
  ...
  //prevent state from leaking between each invocation of the Client.search API call
  afterEach(() => {
  ...
  describe('user populates search field', () => {
    ...
    //assert the zeroth arg of the invocation matches searchValue
    ...
    describe('and API returns results', () => {
      ...
      describe('then user clicks food item', () => {
        beforeEach(() => {
          // ...simulate usesr clicking food item
      ...
      describe('then user types more', () => {
        ...
        beforeEach(() => {
          // ...simulate user typing 'x' (not in food db)
          const input = wrapper.find('input').first();
          input.simulate('change', {
            target: { value: value },
          });
